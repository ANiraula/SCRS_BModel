...
BenefitModel <- function(employee = "Blend", tier = 3, NCost = FALSE,
                         ARR = 0.05, COLA = 0.05, BenMult = 0.05, DC = TRUE, e.age = 27,
                         DC_EE_cont = 0.05, DC_ER_cont = 0.05, DC_return = 0.05){
  ################################# 
...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(width = 3,
                 ...
                 selectInput("e.age", "Entry Age", choices = c(20, 22, 27, 32, 37, 42, 47, 52, 57, 62, 67), selected = 27),
                 ...
                 sliderInput("mult", "Benefit Multiplier", min = 0.82, max = 2.82, step = 0.05, value = 1.82),
